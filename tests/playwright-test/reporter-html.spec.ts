...
for (const useIntermediateMergeReport of [true, false] as const) {
  test.describe(`${useIntermediateMergeReport ? 'merged' : 'created'}`, () => {
    ...
    test('should include image diff', async ({ runInlineTest, page, showReport }) => {
      const expected = Buffer.from('', 'base64');
      const result = await runInlineTest({
        'playwright.config.ts': `
    ...
    test('should include image diffs for same expectation', async ({ runInlineTest, page, showReport }) => {
      const expected = Buffer.from('', 'base64');
      const result = await runInlineTest({
        'playwright.config.ts': `
          module.exports = { use: { viewport: { width: 200, height: 200 }} };
        `,
    ...
    test('should not include image diff with non-images', async ({ runInlineTest, page, showReport }) => {
      const expected = Buffer.from('', 'base64');
      const result = await runInlineTest({
        'playwright.config.ts': `
          module.exports = { use: { viewport: { width: 200, height: 200 }} };
        `,
    ...
    test('should filter out tests with specific annotation using !annot', async ({ runInlineTest, showReport, page }) => {
      const result = await runInlineTest({
        'a.test.js': `
          const { test, expect } = require('@playwright/test');
          test('annotated test', { annotations: [{ type: 'skip', description: 'skipped' }] }, async ({}) => {
            expect(1).toBe(1);
          });
          test('non-annotated test', async ({}) => {
            expect(1).toBe(1);
          });
        `,
      }, { reporter: 'dot,html' }, { PLAYWRIGHT_HTML_OPEN: 'never' });
      ...
      await searchInput.fill('!annot:skip');
      await expect(page.getByText('non-annotated test')).toBeVisible();
      await expect(page.getByText('annotated test')).not.toBeVisible();
    });
  });
}
